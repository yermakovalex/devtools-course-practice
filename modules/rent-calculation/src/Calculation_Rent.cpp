...
Calculation_Rent::Calculation_Rent(double am_pay, double re_term,
    ...
    if (int_rate > 10000000 || re_term > 10000000 || am_pay > 100000000) {
...
double Calculation_Rent::Rent_Accum_P_Period_postnum(double nominal_rate,
...
double Calculation_Rent::Rent_Accum_P_Period_prenum(double nominal_rate,
    int number_compounding_per_year, int number_payments_per_year) {
    if (nominal_rate <= 0 || rent_term <= 0 || amount_payment <= 0
        || number_compounding_per_year <= 0 || number_payments_per_year <= 0) {
        throw "Enter a wrong mumber";
...
double Calculation_Rent::Rent_Modern_P_Period_postnum(double nominal_rate,
    int number_compounding_per_year, int number_payments_per_year) {
    if (nominal_rate <= 0 || rent_term <= 0 || amount_payment <= 0
        || number_compounding_per_year <= 0 || number_payments_per_year <= 0) {
        throw "Enter a wrong mumber";
...
double Calculation_Rent::Rent_Modern_P_Period_prenum(double nominal_rate,
    int number_compounding_per_year, int number_payments_per_year) {
    if (nominal_rate <= 0 || rent_term <= 0 || amount_payment <= 0
        || number_compounding_per_year <= 0 || number_payments_per_year <= 0) {
        throw "Enter a wrong mumber";
